<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    @endif
                     ...
                     <!-- Authentication -->
                <form method="POST"
                            action="{{ Auth::guard('superadmin')->check() ? route('superadmin.logout') : route('logout') }}">
                            @csrf

                            <x-dropdown-link :href="Auth::guard('superadmin')->check() ? route('superadmin.logout') : route('logout')"
    ...
    <x-dropdown-link :href="Auth::guard('superadmin')->check() ? route('logout') : route('logout')"
        onclick="event.preventDefault(); this.closest('form').submit();">
        {{ __('Log Out') }}
    </x-dropdown-link>
</form>
